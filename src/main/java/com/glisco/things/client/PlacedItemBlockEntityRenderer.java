        ...
        if (entity.getItem() != null) {
            ...
            switch (entity.getWorld().getBlockState(entity.getPos()).get(Properties.FACING)) {
                case UP:
                    ...
                    matrixStack.multiply(Vector3f.NEGATIVE_Y.getDegreesQuaternion(entity.getRotation() * 45));
                    break;
                case DOWN:
                ...
                case EAST:
                    ...
                    matrixStack.multiply(Vector3f.NEGATIVE_X.getDegreesQuaternion(90 - entity.getRotation() * 45));
                    matrixStack.multiply(Vector3f.POSITIVE_Z.getDegreesQuaternion(90));
                    break;
                case WEST:
                    matrixStack.translate(0.03, 0.5, 0.5);
                    matrixStack.multiply(Vector3f.NEGATIVE_X.getDegreesQuaternion(90 + entity.getRotation() * 45));
                    matrixStack.multiply(Vector3f.NEGATIVE_Z.getDegreesQuaternion(90));
                    break;
                case NORTH:
                    matrixStack.translate(0.5, 0.5, 0.03);
                    matrixStack.multiply(Vector3f.NEGATIVE_X.getDegreesQuaternion(90));
                    matrixStack.multiply(Vector3f.POSITIVE_Z.getDegreesQuaternion(180));
                    matrixStack.multiply(Vector3f.POSITIVE_Y.getDegreesQuaternion(-entity.getRotation() * 45));
                    break;
                case SOUTH:
